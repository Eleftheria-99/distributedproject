...
public class AcceptedForm_Geo {
	...
	public AcceptedForm_Geo() {
	}

	public AcceptedForm_Geo(String fname, String lname, String email, int phone_number, String place_of_residence,
	...
	public String toString() {
		return "AcceptedForm_Geo [id=" + id + ", fname=" + fname + ", lname=" + lname + ", email=" + email

...
@Entity
@Table(name = "ACCEPTEDFORM_OIK")
public class AcceptedForm_Oik implements Serializable{
	...
	public AcceptedForm_Oik() {}
	
	public AcceptedForm_Oik(String fname, String lname, String email, int phone_number, String place_of_residence,
	...
	public String toString() {
		return "AcceptedForm_Oik [id=" + id + ", fname=" + fname + ", lname=" + lname + ", email=" + email

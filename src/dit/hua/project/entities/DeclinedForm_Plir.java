...
@Entity
@Table(name = "DECLINEDFORM_PLIR")
public class DeclinedForm_Plir implements Serializable{
	...
	public DeclinedForm_Plir() {}
	public DeclinedForm_Plir(String fname, String lname, String email, int phone_number,
	...
	public String toString() {
		return "DeclinedForm_Plir [id=" + id + ", fname=" + fname + ", lname=" + lname + ", email=" + email

...
@Entity
@Table(name = "DECLINEDFORM_OIK")
public class DeclinedForm_Oik implements Serializable{
	...
	public DeclinedForm_Oik() {}
	public DeclinedForm_Oik(String fname, String lname, String email, int phone_number, String place_of_residence,
	...
	public String toString() {
		return "DeclinedForm_Oik [id=" + id + ", fname=" + fname + ", lname=" + lname + ", email=" + email

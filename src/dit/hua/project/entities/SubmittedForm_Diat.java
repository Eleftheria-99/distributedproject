...
@Entity
@Table(name = "SUBMFORM_DIAT")
public class SubmittedForm_Diat {
...
//	@OneToOne(cascade=CascadeType.ALL)                                       //annotation for foreign key  in users.java
	...
	public SubmittedForm_Diat() {
		
	}


	public SubmittedForm_Diat(String fname, String lname, String email, int phoneNumber, String placeOfResidence,

...
@Entity
@Table(name = "DECLINEDFORM_GEO")
public class DeclinedForm_Geo implements Serializable{
	...
	public DeclinedForm_Geo() {
	}

	public DeclinedForm_Geo(String fname, String lname, String email, int phone_number, String place_of_residence,
	...
	public String toString() {
		return "DeclinedForm_Geo [id=" + id + ", fname=" + fname + ", lname=" + lname + ", email=" + email

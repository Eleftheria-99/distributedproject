...
@Entity
@Table(name = "ACCEPTEDFORMS_DIAT")
public class AcceptedForms_Diat   implements Serializable{
	...
	protected String place_of_living;            //place of studying
	...
	public AcceptedForms_Diat() {}
	public AcceptedForms_Diat( String fname, String lname, String email, int phone_number,
	...
	public String toString() {
		return "AcceptedForms_Diat [id=" + id + ", fname=" + fname + ", lname=" + lname + ", email=" + email

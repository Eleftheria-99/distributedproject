...
public class StudentRestController {
	...
	public String showLogInERROR() {
		...
		System.out.println("ready to show: log in ERROR  page");

		return "This is the login-error-page";
	}
	
	
	@RequestMapping(value = "/login/main-menu-for-all", method = RequestMethod.POST, produces = "application/json",  consumes = "application/json")
	...
	public @ResponseBody Users showMainMenuForAll(HttpServletRequest request, Model model, HttpSession session) {
		...
		user = new Users();
		System.out.println("DS: username_send_from_client_from_form_login_with_post: "+ username_send_from_client_from_form_login_with_post.toString());
		user = return_username_and_department(username_send_from_client_from_form_login_with_post); // returns object type of Users, which contains the username and
														// the department
		System.out.println("DS: main menu for all users page: user : "+ user.toString());
		return user;
	}

	// here we want to return the department
	@GetMapping(value = "/login/main-menu-for-all/showForm", produces = "application/json", consumes="application/json")
	public @ResponseBody Users getdepartment(HttpSession session) {
		System.out.println("ready to show: form");

		return return_username_and_department( username_send_from_client_from_form_login_with_post);
...
//	}
	...
	@GetMapping(value = "/login/main-menu-for-all/change-data", produces = "application/json", consumes="application/json")
	public @ResponseBody Users ChangePersonalData() {
	...
	@GetMapping(value = "/login/main-menu-for-all/showResults", produces = "application/json", consumes="application/json")
	...
	protected Users return_username_and_department( String username_from_client) {  //returns object that contains the username from the user, that was sent to the server through post reqeust and the department that was found in the database

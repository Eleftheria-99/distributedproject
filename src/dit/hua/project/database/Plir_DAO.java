...
public interface Plir_DAO {
	...
	public ArrayList<AcceptedForms_Plir> get_the_accepted_forms_order_by_desc_and_until_limit_plir(int limit_of_students_entitled_to_free_meals);
	...
	public void delete_a_row_from_subform_table(int id_of_the_submitted_form ); //delete a row from submitted forms based on the id
